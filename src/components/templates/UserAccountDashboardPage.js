...
import AuthPageStruct from "../modules/signIn/AuthPageStruct";
...
const UserAccountDashboardPage = () => {
    ...
    {profileStore.data.is_2fa?
            ...
            <ModalPage isOpen={modalOpen} >
                    ...
                    md:shadow-lg
                    ">
                        <button onClick={()=>{setModalOpen(false)}} className="font-bold py-2 px-4 rounded text-xl flex items-center justify-center">
                            <Close/>
                        </button>
                        <div className="
                        mt-16
