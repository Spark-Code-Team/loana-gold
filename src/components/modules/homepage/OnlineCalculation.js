...
const OnlineCalculation = () => {
    return(
        ...
        <div className="md:w-1/2 w-full">
            ...
            <div className="md:w-full md:m-auto md:mt-0 mt-8 font-bold md:text-right text-center md:pr-10 pr-0">لونا اولین پلتفرم خرید قسطی طلا آب شده</div>
            ...
            <div className="md:w-[90%] w-[90%] m-auto mt-10 pt-8 pb-8 pr-4 pl-4 border-[1.5px] border-[#E1E1E1] rounded-xl">
                ...
                <div className="w-full m-auto md:mt-2 mt-3">
                    ...
                    <input type="text" name="" className="w-full md:h-[56px] rounded-xl border-[1.5px] border-[#E1E1E1] mt-4" placeholder="مبلغ دریافتی به ریال"/>
